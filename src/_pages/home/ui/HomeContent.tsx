...
// - 로딩은 HomePage의 Suspense fallback(HomeContentSkeleton), 에러는 error.tsx(ErrorBoundary)가
//   선언적으로 처리한다. 라우트 레벨 loading.tsx는 두지 않는다(초기 HTML에 Header·h1이 두 벌 실린다).
...
// Hero는 데이터 소유권이 갈려 HomePage가 껍데기·이미지를 소유하고 카피만 따로 스트리밍한다.
