...
function HomeErrorFallback({ error, onRetry }: { error: unknown; onRetry: () => void }) {
  return (
    <div className="rounded-gds-md bg-white py-20 text-center text-sm text-gds-gray-700 shadow-[inset_0_0_0_1px_var(--color-gds-gray-200)]">
      ...
      <button
        className="mt-4 cursor-pointer rounded-gds-sm border border-gds-cta bg-gds-cta px-4 py-2 text-sm font-semibold text-white hover:bg-gds-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gds-green-500"
        type="button"
        onClick={onRetry}
      >
        다시 시도
