...
import { migrateStoredItems } from '@/shared/lib/validateStoredItems';

// [AI] WishlistItem은 Product의 id만 저장. feature → entity(하위) 방향으로 Product 타입을 참조한다.
type WishlistItem = Pick<Product, 'id'>;
