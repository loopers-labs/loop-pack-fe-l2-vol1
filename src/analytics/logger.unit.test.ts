...
import { identify, initAnalytics, registerProviders, reset, resetAnalyticsForTest, setCommonProperties, track } from './logger';

type Recorded = { type: 'track'; event: string; properties: EventProperties } | { type: 'identify'; userId: string } | { type: 'reset' };
