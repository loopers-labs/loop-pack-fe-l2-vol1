...
3. Do not call #playwright-test-healer for week 09 Advanced B. The assignment asks to
   compare generated tests with the manually written tests, not to auto-fix them.
