...
| 항목                       | 상태       | 소유자 | 수명 | 공유범위 | 선택이유 |
| -------------------------- | ---------- | ------ | ---- | -------- | -------- |
| 홈·상품목록 데이터         | 서버       | 2      | 3    | 4        | 5        | 6   |
| 검색·카테고리·정렬         | url        | 2      | 3    | 4        | 5        | 6   |
| 장바구니·위시리스트        | 서버       | 2      | 3    | 4        | 5        | 6   |
| 헤더에표시하는개수         | 서버       | 2      | 3    | 4        | 5        | 6   |
| 제출전검색어와 일시적인 UI | 클라이언트 | 2      | 3    | 4        | 5        | 6   |
| 로딩·에러·빈결과           | 클라이언트 | 2      | 3    | 4        | 5        | 6   |
